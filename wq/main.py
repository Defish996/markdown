...
def first_factory(fields):
    ...
    for field in fields:
        tmp = "group_scale(%s, industry)"%(field)
        tmp2 = "((%s - ts_delay(%s,660)) / ts_delay(%s,660))"%(tmp, tmp, tmp)
        alpha = "ts_min(%s, 250)"%(tmp2)
...
def group_factory(op, field, region):
    ...
    glb_group_2 = ['sta2_all_fact1_c10',
'sta2_all_fact2_c10',
'sta2_all_fact2_c50',
'sta2_all_fact3_c50',
'sta2_all_fact4_c50'
